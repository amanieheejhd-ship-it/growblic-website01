...
export function demoPaymentGatewayEnabled(
  environment = process.env.NODE_ENV,
  internshipFlag = process.env.INTERNSHIP_DEMO_PAYMENT_ENABLED,
  legacyFlag = process.env.ENABLE_DEMO_PAYMENT,
) {
  return environment !== "production" && (internshipFlag === "true" || legacyFlag === "true");
}
