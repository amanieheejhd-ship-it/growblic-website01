...
const app = companyApps.find((item) => item.slug === "classta-mentor")!;

export const metadata = {
  title: "Classta Mentor | Growblic App",
  description:
    "Classta Mentor is a tutor-side e-learning app by Growblic for course management, live streaming, homework, analytics, and mentor tools.",
};

export default function ClasstaMentorPage() {
  return (
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Tutor-side app for managing Classta courses, classes, homework, and analytics.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for tutors and digital classrooms.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A mentor-focused feature created to make teaching, course handling, and student management easier.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Classta Mentor gives tutors tools for creating courses, uploading
                  course thumbnails and materials, managing live sessions, handling
                  homework, checking analytics, and tracking course performance.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-blue-100 bg-blue-50/70 p-6">
                ...
                <p className="mt-4 text-sm font-bold leading-7 text-slate-700">
                  Course management and edit options improved, bug fixes added,
                  and tutor workflow made smoother.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar mentor app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build e-learning platforms, tutor apps, admin panels,
                  live class systems, homework modules, and course management dashboards.
                </p>
              </div>
