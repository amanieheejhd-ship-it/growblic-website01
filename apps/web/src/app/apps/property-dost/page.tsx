...
const app = companyApps.find((item) => item.slug === "property-dost")!;

export const metadata = {
  title: "Property Dost | Growblic App",
  description:
    "Property Dost is a smart real estate app by Growblic for buying, selling, renting, property listings, chat, KYC verification, and admin dashboard.",
};

export default function PropertyDostPage() {
  return (
        ...
        <div className="relative mx-auto max-w-[1800px]">
          ...
          <div className="mt-8 grid min-w-0 gap-8 sm:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            ...
            <div className="min-w-0 rounded-[2rem] border border-blue-100/70 bg-white/90 p-5 shadow-2xl shadow-blue-100/60 backdrop-blur-xl">
              <div className="relative overflow-hidden rounded-[1.6rem] sm:rounded-[2.5rem] bg-gradient-to-br from-violet-50 via-white to-blue-50 p-8">
                <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-violet-200/60 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Smart property app for buying, selling, renting, and managing homes instantly.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for modern real estate deals.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A real estate feature designed to make property discovery,
                      listing, and management easier.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Property Dost helps buyers and sellers manage property deals
                  with easy login, filters, listings, chat, favorites, KYC,
                  notifications, and an admin dashboard for authorized users.
                </p>
              </div>

              <div className="mt-6 rounded-[1.5rem] border border-violet-100 bg-violet-50 p-6">
                ...
                <p className="mt-4 text-sm font-bold leading-7 text-slate-700">
                  Real estate should be simple, transparent, and accessible for everyone.
                </p>
              </div>
            </div>
          </div>

          <div className="mt-12 overflow-hidden rounded-[2rem] border border-blue-100/70 bg-gradient-to-br from-slate-950 via-blue-950 to-violet-950 p-8 text-white shadow-2xl shadow-blue-100/60">
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Real Estate Product
                </p>

                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar property app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build real estate apps, listing platforms, partner
                  dashboards, KYC systems, chat modules, and admin panels.
                </p>
              </div>
