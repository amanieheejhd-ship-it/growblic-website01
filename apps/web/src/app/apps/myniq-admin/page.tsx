...
const app = companyApps.find((item) => item.slug === "myniq-admin")!;

export const metadata = {
  title: "Myniq Admin | Growblic App",
  description:
    "Myniq Admin is an e-commerce admin app by Growblic for inventory, orders, products, categories, promo codes, analytics, and store management.",
};

export default function MyniqAdminPage() {
  return (
    <main className="min-h-screen overflow-hidden">
      <section className="relative px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(245,158,11,0.11),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(168,85,247,0.07),transparent_30%)]" />
        ...
        <div className="relative mx-auto max-w-[1800px]">
          ...
          <div className="mt-8 grid min-w-0 gap-8 sm:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            ...
            <div className="min-w-0 rounded-[2rem] border border-blue-100/70 bg-white/90 p-5 shadow-2xl shadow-blue-100/60 backdrop-blur-xl">
              <div className="relative overflow-hidden rounded-[1.6rem] sm:rounded-[2.5rem] bg-gradient-to-br from-orange-50 via-white to-blue-50 p-8">
                <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-orange-200/60 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Complete admin control for products, orders, inventory, promo codes, and sales insights.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for e-commerce store management.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A store admin feature designed to help business owners manage daily e-commerce operations easily.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Myniq Admin helps store owners track stock, manage products and
                  categories, process customer orders, manage order fulfillment,
                  create promo codes, view analytics, and control store operations
                  with real-time updates.
                </p>
              </div>

              <div className="mt-6 rounded-[1.5rem] border border-orange-100 bg-orange-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  ...
                  <li>✓ View and update customer orders</li>
                  <li>✓ Create and manage promo codes</li>
                  <li>✓ View analytics based on sales and order status</li>
                </ul>
              </div>
            </div>
          </div>

          <div className="mt-12 overflow-hidden rounded-[2rem] border border-blue-100/70 bg-gradient-to-br from-slate-950 via-blue-950 to-orange-950 p-8 text-white shadow-2xl shadow-blue-100/60">
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar admin app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build e-commerce admin panels, inventory systems,
                  order management apps, analytics dashboards, promo code tools,
