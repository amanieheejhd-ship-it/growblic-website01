...
const app = companyApps.find((item) => item.slug === "fresh-fade-in")!;

export const metadata = {
  title: "Fresh Fade : IN | Growblic App",
  description:
    "Fresh Fade : IN is a barber booking admin app by Growblic for salon services, barber profiles, banners, credentials, emails, passwords, and admin operations.",
};

export default function FreshFadeINPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfdff]">
      <section className="relative px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(234,179,8,0.10),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(14,165,233,0.08),transparent_30%)]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid min-w-0 gap-8 sm:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            ...
            <div className="min-w-0 rounded-[2rem] border border-blue-100/70 bg-white/90 p-5 shadow-2xl shadow-blue-100/60 backdrop-blur-xl">
              <div className="relative overflow-hidden rounded-[1.6rem] sm:rounded-[2.5rem] bg-gradient-to-br from-yellow-50 via-white to-blue-50 p-8">
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Smart admin platform for managing barber shops, services, barbers, and operations.
                    </p>
                  </div>
                </div>
              </div>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      An admin feature designed to make barbershop management faster, organized, and hassle-free.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Fresh Fade : IN helps salon administrators manage barber services,
                  profiles, barber lists, banners, offers, credentials, emails, and
                  passwords while keeping business data stored securely in Firebase.
                </p>
              </div>

              <div className="mt-6 rounded-[1.5rem] border border-yellow-100 bg-yellow-50 p-6">
                ...
                <p className="mt-4 text-sm font-bold leading-7 text-slate-700">
                  Fresh Fade : IN internal testing build for smart barbershop admin management.
                </p>
              </div>
            </div>
          </div>

          <div className="mt-12 overflow-hidden rounded-[2rem] border border-blue-100/70 bg-gradient-to-br from-slate-950 via-blue-950 to-yellow-950 p-8 text-white shadow-2xl shadow-blue-100/60">
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build salon admin apps, booking systems, barber panels,
                  Firebase dashboards, business tools, and service management apps.
                </p>
              </div>
