...
const app = companyApps.find((item) => item.slug === "ins-petro")!;

export const metadata = {
  title: "INS PETRO | Growblic App",
  description:
    "INS PETRO is a PDI report management app by Growblic for creating, managing, tracking, organizing, and exporting inspection reports as professional PDFs.",
};

export default function INSPetroPage() {
  return (
    <main className="min-h-screen overflow-hidden">
      <section className="relative px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(14,165,233,0.10),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(100,116,139,0.08),transparent_30%)]" />
        ...
        <div className="relative mx-auto max-w-[1800px]">
          ...
          <div className="mt-8 grid min-w-0 gap-8 sm:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            ...
            <div className="min-w-0 rounded-[2rem] border border-blue-100/70 bg-white/90 p-5 shadow-2xl shadow-blue-100/60 backdrop-blur-xl">
              <div className="relative overflow-hidden rounded-[1.6rem] sm:rounded-[2.5rem] bg-gradient-to-br from-blue-50 via-white to-slate-50 p-8">
                <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-blue-200/60 blur-3xl" />
                <div className="absolute -left-20 bottom-0 h-60 w-60 rounded-full bg-slate-200/50 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Create, manage, and export PDI reports quickly with a professional workflow.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for dealership inspection reporting.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A professional inspection feature designed to make reporting, tracking, and record keeping faster.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  INS PETRO helps teams create and manage Pre-Delivery Inspection
                  reports for multiple manufacturers, car models, and variants,
                  track the status of each inspection, and export clean PDF reports.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-blue-100 bg-blue-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  <li>✓ New INS PETRO app update</li>
                  <li>✓ Professional PDI workflow</li>
                  <li>✓ Vehicle inspection report management</li>
                  <li>✓ PDF export support</li>
                  <li>✓ Better record keeping for service teams</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Inspection Product
                </p>

                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar report management app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build inspection apps, PDF report generators,
                  dealership tools, service center apps, record management systems,
