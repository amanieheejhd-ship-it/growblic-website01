...
const app = companyApps.find((item) => item.slug === "jeev-setu")!;

export const metadata = {
  title: "Jeev Setu | Growblic App",
  description:
    "Jeev Setu is a farm and dairy management app by Growblic for livestock tracking, milk production, breeding records, animal health logs, expenses, and dairy operations.",
};

export default function JeevSetuPage() {
  return (
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Smart farm and dairy management companion for farmers and milkmen.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for smart farm and dairy operations.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A farm-focused feature designed to help users organize animals, records, finance, and daily work.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Jeev Setu helps farmers and milkmen manage livestock, milk
                  production, breeding records, insemination details, animal
                  health logs, expenses, feed, medicines, labor costs, and daily
                  dairy operations from one simple app.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-green-100 bg-green-50 p-6">
                ...
                <p className="mt-4 text-sm font-bold leading-7 text-slate-700">
                  It helps farmers stay organized, make informed decisions, and
                  improve productivity with modern farm and dairy tools.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Farm Product
                </p>

                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar farm management app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build agriculture apps, dairy management systems,
                  inventory tools, finance tracking apps, dashboards, and SaaS platforms.
                </p>
              </div>
