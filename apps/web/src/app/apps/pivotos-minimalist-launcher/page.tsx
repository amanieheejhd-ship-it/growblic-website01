...
const app = companyApps.find((item) => item.slug === "pivotos-minimalist-launcher")!;

export const metadata = {
  title: "PivotOS : Minimalist Launcher | Growblic App",
  description:
    "PivotOS : Minimalist Launcher is a one-hand Android launcher by Growblic for productivity, speed, focus, gesture controls, themes, customization, and lightweight performance.",
};

export default function PivotOSMinimalistLauncherPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfdff]">
      <section className="relative px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(34,197,94,0.10),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(244,63,94,0.08),transparent_30%)]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid min-w-0 gap-8 sm:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            ...
            <div className="min-w-0 rounded-[2rem] border border-blue-100/70 bg-white/90 p-5 shadow-2xl shadow-blue-100/60 backdrop-blur-xl">
              <div className="relative overflow-hidden rounded-[1.6rem] sm:rounded-[2.5rem] bg-gradient-to-br from-green-50 via-white to-rose-50 p-8">
                <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-green-200/60 blur-3xl" />
                <div className="absolute -left-20 bottom-0 h-60 w-60 rounded-full bg-rose-200/50 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Minimalist one-hand launcher built for productivity, speed, and focus.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for cleaner Android productivity.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A launcher feature designed to make Android navigation faster, simpler, and more focused.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  PivotOS helps users transform Android into a cleaner and faster
                  experience with quick access to apps, one-hand usability,
                  gesture controls, clean layouts, wallpapers, icon customization,
                  themes, and performance-optimized navigation.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-green-100 bg-green-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  <li>✓ Icon shape and text style customization</li>
                  <li>✓ Live preview added</li>
                  <li>✓ Improved performance and faster loading</li>
                  <li>✓ Enhanced stability and device compatibility</li>
                  <li>✓ Smoother animations and refined UI</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Launcher Product
                </p>

                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar launcher app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build Android launchers, productivity apps, custom UI tools,
                  utility apps, mobile customization apps, and performance-focused products.
                </p>
              </div>
