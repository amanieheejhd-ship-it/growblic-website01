...
const app = companyApps.find((item) => item.slug === "payroll-hr")!;

export const metadata = {
  title: "PayRoll+HR | Growblic App",
  description:
    "PayRoll+HR is a payroll and HR management app by Growblic for GPS attendance, employee management, salary slips, attendance tracking, reports, analytics, and HR tools.",
};
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfdff]">
      <section className="relative px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(14,165,233,0.10),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(34,197,94,0.08),transparent_30%)]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid min-w-0 gap-8 sm:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:mt-9 sm:flex-row sm:flex-wrap">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-12 w-full items-center justify-center rounded-full bg-gradient-to-r from-slate-950 via-blue-950 to-cyan-950 px-8 py-4 text-sm font-black text-white shadow-xl shadow-blue-100/70 transition-all duration-500 ease-out hover:-translate-y-1.5 sm:w-auto"
                >
                  Open on Play Store →
                </a>
            ...
            <div className="min-w-0 rounded-[2rem] border border-blue-100/70 bg-white/90 p-5 shadow-2xl shadow-blue-100/60 backdrop-blur-xl">
              <div className="relative overflow-hidden rounded-[1.6rem] sm:rounded-[2.5rem] bg-gradient-to-br from-blue-50 via-white to-green-50 p-8">
                <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-blue-200/60 blur-3xl" />
                <div className="absolute -left-20 bottom-0 h-60 w-60 rounded-full bg-green-200/50 blur-3xl" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      GPS attendance, employee data, and salary slips in one smart app.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for automated payroll and attendance.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      An HR feature designed to help businesses manage teams, attendance, salary records, and reports faster.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  PayRoll+HR helps businesses mark GPS attendance, manage employee
                  profiles, track attendance records, calculate salary, generate PDF
                  salary slips, export reports, send reminders, and manage HR tasks.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-green-100 bg-green-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  <li>✓ Mark attendance with GPS in seconds</li>
                  <li>✓ Auto-generate salary slips</li>
                  <li>✓ Manage employee data easily</li>
                  <li>✓ Payroll and HR workflow improved</li>
                  <li>✓ Reports and analytics added</li>
                </ul>
              </div>
            </div>
          </div>

          <div className="mt-12 overflow-hidden rounded-[2rem] border border-blue-100/70 bg-gradient-to-br from-slate-950 via-blue-950 to-green-950 p-8 text-white shadow-2xl shadow-blue-100/60">
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar HR payroll app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build payroll apps, attendance systems, employee
                  dashboards, salary slip generators, HR tools, and business management platforms.
                </p>
              </div>
