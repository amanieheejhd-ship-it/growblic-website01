...
const app = companyApps.find((item) => item.slug === "true-auth")!;

export const metadata = {
  title: "True Auth | Growblic App",
  description:
    "True Auth is a secure credential manager by Growblic with 2FA, TOTP, OAuth, encrypted sync, password vault, biometric unlock, secure notes, and backup.",
};

export default function TrueAuthPage() {
  return (
    <main className="min-h-screen overflow-hidden">
      <section className="relative px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(14,165,233,0.12),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(99,102,241,0.09),transparent_30%)]" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Secure credential manager with 2FA, TOTP, OAuth, and encrypted sync.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for secure digital identity protection.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A security feature designed to protect accounts, passwords, documents, and private data.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  True Auth helps users store logins, email accounts, notes,
                  addresses, identity documents, credit card details, TOTP codes,
                  and passwords inside an encrypted vault with secure backup and sync.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-blue-100 bg-blue-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  <li>✓ Production True Auth 1.0</li>
                  <li>✓ Secure credential manager</li>
                  <li>✓ TOTP and 2FA support</li>
                  <li>✓ Biometric authentication</li>
                  <li>✓ Encrypted cloud sync and backup</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar security app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build password managers, authenticator apps,
                  secure vaults, encrypted sync systems, biometric login apps,
                  and privacy-focused mobile products.
                </p>
              </div>
