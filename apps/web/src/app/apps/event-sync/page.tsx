...
const app = companyApps.find((item) => item.slug === "event-sync")!;

export const metadata = {
  title: "Event Sync | Growblic App",
  description:
    "Event Sync is an event discovery and booking app by Growblic for concerts, workshops, meetups, festivals, secure payments, favorites, journals, booking history, and notifications.",
};
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Discover, book, save, and manage events near you with a clean mobile experience.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for simple event discovery and booking.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      An event-focused feature created to help users discover, book, save, and remember events easily.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Event Sync helps users discover events around them, book tickets,
                  make payments, save favorites, write journals, capture memories,
                  view booking history, and receive event updates and notifications.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-pink-100 bg-pink-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  <li>✓ Fixed layout issue in landing page</li>
                  <li>✓ Button visibility improved</li>
                  <li>✓ Event booking experience improved</li>
                  <li>✓ Notifications and event details flow</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Event Product
                </p>

                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar event booking app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build event booking apps, ticketing platforms,
                  payment systems, recommendation engines, journals, and booking dashboards.
                </p>
              </div>
