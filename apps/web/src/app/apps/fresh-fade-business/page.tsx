...
const app = companyApps.find((item) => item.slug === "fresh-fade-business")!;

export const metadata = {
  title: "Fresh Fade : Business | Growblic App",
  description:
    "Fresh Fade : Business is a barber business management app by Growblic for dashboard, revenue, ratings, services, chat, slot management, bookings, and shop operations.",
};

export default function FreshFadeBusinessPage() {
  return (
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.5rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Smart barber shop booking and business management ecosystem.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid min-w-0 gap-8 sm:mt-16 lg:grid-cols-[1fr_0.85fr] lg:gap-10">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl break-words text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Built for barber business operations.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A barber-business feature designed to make shop management, booking, and client service smoother.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="min-w-0 rounded-[1.75rem] border border-blue-100/70 bg-white p-5 sm:rounded-[2.5rem] sm:p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 sm:rounded-[2rem] sm:p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Fresh Fade : Business helps barber shop owners manage requests,
                  promotions, revenue, ratings, services, chats, settings, profiles,
                  bookings, holidays, slot availability, and daily business operations.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[1.5rem] border border-yellow-100 bg-yellow-50 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  ...
                  <li>✓ Track revenue and bookings</li>
                  <li>✓ Improve customer experience</li>
                  <li>✓ Run barber business smoothly</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid min-w-0 gap-6 sm:gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Business Product
                </p>

                <h2 className="mt-4 break-words text-3xl font-black tracking-tight sm:text-4xl md:text-5xl">
                  Want a similar business panel app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build business management apps, booking panels,
                  salon systems, admin dashboards, payment tools, and service platforms.
                </p>
              </div>
