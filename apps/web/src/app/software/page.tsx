...
const features = [
  {
    ...
    text: "Clean operating dashboards for teams, reports, approvals, and daily business control.",
    chips: ["Operations", "Control"],
  },
  {
    icon: Layers3,
    title: "Internal tools",
    text: "Custom tools built around your real workflow instead of forcing your team into generic software.",
    chips: ["Custom UI", "Team flow"],
  },
  {
    icon: Workflow,
    title: "Workflow systems",
    text: "Step-by-step systems for requests, approvals, task tracking, and repeatable business processes.",
    chips: ["Automation", "Tracking"],
  },
  {
    icon: LockKeyhole,
    title: "Role-based access",
    text: "Separate access for owners, admins, staff, managers, and users where your product needs it.",
    chips: ["Secure", "Roles"],
  },
  {
    icon: BarChart3,
    title: "Reports & analytics",
    text: "Useful views for performance, activity, revenue, users, and important business decisions.",
    chips: ["Reports", "Insights"],
  },
  {
    icon: Database,
    title: "Scalable architecture",
    text: "A clean base that can grow with modules, users, dashboards, and future product features.",
    chips: ["Scalable", "Reliable"],
  },
];
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-lg font-semibold leading-8 text-slate-600">
              Growblic builds dashboards, internal tools, admin panels, workflow
              systems, and business platforms that help teams work faster with
              clean, scalable digital systems.
            </p>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {highlights.map((item, index) => (
                <div
                  key={item}
                  className="group rounded-[1.4rem] border border-blue-100 bg-white/85 p-4 shadow-[0_18px_55px_rgba(15,23,42,0.07)] backdrop-blur-xl transition hover:-translate-y-1 hover:border-blue-200"
                >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/start-project"
                className="inline-flex h-13 items-center justify-center gap-2 rounded-full bg-slate-950 px-6 py-4 text-sm font-black text-white shadow-[0_18px_45px_rgba(15,23,42,0.22)] transition hover:-translate-y-0.5 hover:bg-blue-700"
              >
                Start Project
              ...
              <Link
                ...
                className="inline-flex h-13 items-center justify-center rounded-full border border-blue-100 bg-white/85 px-6 py-4 text-sm font-black text-slate-800 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:text-blue-700"
              >
                Estimate Budget
              </Link>
            </div>
                ...
                <div className="mb-5 flex items-center justify-between">
                  <div>
                    <p className="text-xs font-black uppercase tracking-[0.32em] text-cyan-300">
                      Growblic Software OS
                    </p>
                    <h2 className="mt-2 text-2xl font-black">Business control center</h2>
                  </div>
                ...
                <div className="grid gap-4 sm:grid-cols-[1.1fr_0.9fr]">
                  <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.07] p-5">
                    <div className="flex items-center justify-between">
                      <p className="font-black">Workflow pipeline</p>
                      <Zap className="h-5 w-5 text-cyan-300" />
                    </div>

                    <div className="mt-5 space-y-3">
                      {["Requirement", "Design", "Build", "Launch"].map((item, index) => (
                        <div
                          key={item}
                  ...
                  <div className="space-y-4">
                    <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.07] p-5">
                      <p className="text-sm font-bold text-slate-300">Active modules</p>
                      <p className="mt-3 text-5xl font-black tracking-[-0.05em]">12</p>
                    ...
                    <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.07] p-5">
                      <p className="text-sm font-bold text-slate-300">Access system</p>
        ...
        <div className="rounded-[2.4rem] border border-blue-100 bg-white/72 p-5 shadow-[0_30px_100px_rgba(15,23,42,0.08)] backdrop-blur-2xl sm:p-6">
          <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="max-w-xl text-sm font-semibold leading-6 text-slate-600">
              Every module is planned around your workflow, team roles, data,
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base font-medium leading-7 text-slate-300">
                ...
                handle the complete software journey.
              </p>
            </div>
