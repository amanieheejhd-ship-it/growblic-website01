              ...
              {scopeLinks.map((item) => {
                ...
                return (
                  <Link
                    key={item.label}
                    href={item.href}
                    className="group flex items-center justify-between rounded-2xl border border-blue-100 bg-white/86 px-5 py-4 font-black text-slate-800 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-300 hover:bg-white hover:text-blue-700 hover:shadow-[0_18px_50px_rgba(37,99,235,0.12)]"
                  >
          ...
          {developerCards.map((card) => {
            ...
            return (
              <Link
                ...
                id={card.id}
                href={card.href}
                className="group relative min-h-[250px] overflow-hidden rounded-[1.7rem] border border-blue-100 bg-white/80 p-6 shadow-[0_20px_65px_rgba(37,99,235,0.08)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-300 hover:bg-white hover:shadow-[0_30px_85px_rgba(37,99,235,0.14)]"
              >
                ...
                <h2 className="relative mt-8 text-2xl font-black tracking-[-0.04em] text-slate-950">
                  {card.title}
                </h2>
        ...
        <section className="mt-12 rounded-[2rem] border border-blue-100 bg-white/82 p-7 shadow-[0_25px_85px_rgba(37,99,235,0.10)] backdrop-blur-2xl sm:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-3xl font-black tracking-[-0.05em] text-slate-950 sm:text-4xl">
