      ...
      <section className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-10">
        <div className="grid gap-10 lg:grid-cols-[1fr_0.92fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-7 max-w-4xl text-5xl font-black leading-[0.92] tracking-[-0.07em] text-slate-950 sm:text-6xl lg:text-7xl">
            ...
            <div className="mt-8 grid gap-3">
              {trustPoints.map((point) => (
                <div
                  key={point}
                  className="group flex items-center gap-4 rounded-2xl border border-blue-100 bg-white/80 px-5 py-4 text-sm font-black text-slate-700 shadow-[0_16px_45px_rgba(37,99,235,0.07)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-300 hover:bg-white"
                >
          ...
          <div className="relative">
            <div className="absolute -inset-4 rounded-[2.4rem] bg-gradient-to-br from-blue-200/45 via-cyan-100/35 to-transparent blur-2xl" />
            <div className="relative overflow-hidden rounded-[2.25rem] border border-blue-100 bg-white/80 p-4 shadow-[0_35px_110px_rgba(37,99,235,0.16)] backdrop-blur-2xl">
              <div className="relative overflow-hidden rounded-[1.85rem] bg-slate-950 p-8 text-white shadow-2xl sm:p-10">
                ...
                <h2 className="relative mt-6 max-w-xl text-4xl font-black leading-[0.98] tracking-[-0.06em] sm:text-5xl">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-2">
          {missionVision.map((item) => {
            ...
            return (
              <article
                key={item.label}
                className="group relative overflow-hidden rounded-[2rem] border border-blue-100 bg-white/78 p-7 shadow-[0_24px_75px_rgba(37,99,235,0.10)] backdrop-blur-2xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-300 hover:bg-white hover:shadow-[0_35px_95px_rgba(37,99,235,0.15)] sm:p-8"
              >
                ...
                <p className="relative mt-7 text-xs font-black uppercase tracking-[0.32em] text-blue-700">
                  {item.label}
                </p>

                <h2 className="relative mt-4 text-3xl font-black leading-tight tracking-[-0.05em] text-slate-950 sm:text-4xl">
                  {item.title}
                </h2>
        ...
        <section className="mt-16">
          ...
          <h2 className="mt-5 max-w-4xl text-4xl font-black leading-tight tracking-[-0.06em] text-slate-950 sm:text-5xl">
          ...
          <div className="mt-9 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {buildCards.map((card) => {
              ...
              return (
                <article
                  key={card.title}
                  className="group relative min-h-[220px] overflow-hidden rounded-[1.75rem] border border-blue-100 bg-white/76 p-6 shadow-[0_18px_60px_rgba(37,99,235,0.08)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-300 hover:bg-white hover:shadow-[0_28px_80px_rgba(37,99,235,0.14)]"
                >
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
              {process.map((step, index) => (
                <div
                  key={step}
                  className="rounded-2xl border border-blue-100 bg-white px-5 py-4 text-center shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md"
                >
        ...
        <section className="mt-12 overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-cyan-50 p-7 shadow-[0_25px_85px_rgba(37,99,235,0.10)] sm:p-9">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-4xl font-black leading-tight tracking-[-0.06em] text-slate-950">
