...
const app = companyApps.find((item) => item.slug === "kumbha")!;

export const metadata = {
  title: "Kumbha | Growblic App",
  description:
    "Kumbha is a fast, private, and modern Android web browser by Growblic with clean interface, privacy-focused browsing, light and dark themes, tab history, and voice search.",
};
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfdff]">
      <section className="relative px-6 py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(14,165,233,0.10),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(59,130,246,0.08),transparent_30%)]" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-10 rounded-[2rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Fast, private, and modern browser experience with clean controls.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-[1fr_0.85fr]">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl text-5xl font-black tracking-tight text-slate-950">
                Built for smarter private browsing.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A browser feature designed to make web browsing faster, cleaner, and more controlled.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-[2.5rem] border border-blue-100/70 bg-white p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[2rem] bg-slate-950 p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Kumbha gives users a clean browser interface with fast page
                  loading, privacy-focused browsing, theme customization, tab
                  and history controls, and voice search for quick hands-free access.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-[2rem] border border-blue-100 bg-blue-50 p-6">
                ...
                <p className="mt-4 text-sm font-bold leading-7 text-slate-700">
                  Removed MANAGE_EXTERNAL_STORAGE from the manifest and improved browser safety.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic Browser Product
                </p>

                <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">
                  Want a similar browser app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build browser apps, privacy tools, mobile utilities,
                  secure apps, productivity tools, and custom Android applications.
                </p>
              </div>
