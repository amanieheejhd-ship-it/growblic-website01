...
const app = companyApps.find((item) => item.slug === "chess-offline")!;

export const metadata = {
  title: "Chess Offline | Growblic App",
  description:
    "Chess Offline is a 2-player offline chess strategy game by Growblic. Play classic chess anytime without internet.",
};

export default function ChessOfflinePage() {
  return (
                ...
                <div className="relative">
                  ...
                  <div className="mt-10 rounded-[2rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Offline Chess Classic: play 2-player strategy anytime, anywhere.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-[1fr_0.85fr]">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl text-5xl font-black tracking-tight text-slate-950">
                Built for offline chess strategy.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A clean feature designed to make chess simple, fun, and playable offline.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-[2.5rem] border border-blue-100/70 bg-white p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[2rem] bg-slate-950 p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Step into the timeless world of chess with a beautifully crafted
                  game for challenging a friend, learning ropes, or enjoying strategy
                  without login, internet, or data usage.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">
                  Want a similar game app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build offline games, mobile apps, reward apps,
                  dashboards, SaaS platforms, and custom software products.
                </p>
              </div>
