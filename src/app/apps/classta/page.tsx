...
const app = companyApps.find((item) => item.slug === "classta")!;

export const metadata = {
  title: "Classta | Growblic App",
  description:
    "Classta is a learning management system by Growblic for courses, live classes, assignments, tests, progress tracking, notes, resources, and student learning.",
};

export default function ClasstaPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#fbfdff]">
      <section className="relative px-6 py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_0%,rgba(37,99,235,0.13),transparent_32%),radial-gradient(circle_at_84%_80%,rgba(6,182,212,0.10),transparent_30%),radial-gradient(circle_at_50%_100%,rgba(59,130,246,0.08),transparent_30%)]" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-10 rounded-[2rem] border border-blue-100/70 bg-white/85 p-6 text-center shadow-xl shadow-blue-100/50">
                    ...
                    <p className="mt-4 text-sm font-semibold leading-7 text-slate-500">
                      Complete learning management system for courses, classes, tests, and student progress.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-[1fr_0.85fr]">
            <div>
              ...
              <h2 className="mt-4 max-w-4xl text-5xl font-black tracking-tight text-slate-950">
                Built for modern student learning.
              </h2>
                ...
                {app.features.map((feature, index) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-500">
                      A learning-focused feature created to help students study, practice, track progress, and stay organized.
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="rounded-[2.5rem] border border-blue-100/70 bg-white p-8 shadow-2xl shadow-blue-100/60">
              ...
              <div className="mt-8 rounded-[2rem] bg-slate-950 p-6 text-white">
                ...
                <p className="mt-4 text-sm font-semibold leading-7 text-white/75">
                  Classta gives students a complete learning experience with course
                  library, live classes, assignments, tests, performance tracking,
                  study resources, notes, reminders, progress reports, and smooth
              ...
              <div className="mt-6 rounded-[2rem] border border-blue-100 bg-blue-50/70 p-6">
                ...
                <ul className="mt-4 space-y-3 text-sm font-bold text-slate-700">
                  ...
                  <li>✓ Courses, tests and assignments</li>
                  <li>✓ Progress and performance reports</li>
                  <li>✓ Notes and learning resources</li>
                  <li>✓ Clean student experience</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-center">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.3em] text-cyan-200">
                  Growblic E-Learning Product
                </p>

                <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">
                  Want a similar learning app?
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-7 text-white/70">
                  Growblic can build LMS platforms, student apps, mentor apps,
                  admin panels, live class systems, tests, assignments, and course dashboards.
                </p>
              </div>
