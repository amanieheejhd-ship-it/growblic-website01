...
export const metadata: Metadata = {
  ...
  description: "Explore current opportunities for developers, designers, and growth-focused people.",
};
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:px-8 lg:px-10">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-7 max-w-2xl text-lg font-semibold leading-9 text-slate-600">
            Explore current opportunities for developers, designers, and growth-focused people.
          </p>
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-2">
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Frontend Developer</h3>
              <p className="mt-4 leading-8 text-slate-600">Build premium Next.js and React interfaces.</p>
            </article>
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Backend Developer</h3>
              <p className="mt-4 leading-8 text-slate-600">Create APIs, dashboards, and scalable systems.</p>
            </article>
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">UI/UX Designer</h3>
              <p className="mt-4 leading-8 text-slate-600">Design clean product screens and business experiences.</p>
            </article>
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Digital Marketing Executive</h3>
              <p className="mt-4 leading-8 text-slate-600">Work on SEO, Google Ads, Meta Ads, and content.</p>
            </article>
          </div>
