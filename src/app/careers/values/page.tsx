...
export const metadata: Metadata = {
  ...
  description: "Our values guide how we design, build, communicate, and deliver premium products.",
};
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:px-8 lg:px-10">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-7 max-w-2xl text-lg font-semibold leading-9 text-slate-600">
            Our values guide how we design, build, communicate, and deliver premium products.
          </p>
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-2">
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Ownership</h3>
              <p className="mt-4 leading-8 text-slate-600">We take responsibility for quality and delivery.</p>
            </article>
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Clarity</h3>
              <p className="mt-4 leading-8 text-slate-600">We keep design, content, and execution simple and useful.</p>
            </article>
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Speed with quality</h3>
              <p className="mt-4 leading-8 text-slate-600">We move fast, but never ignore polish.</p>
            </article>
            <article className="rounded-[2rem] border border-blue-100 bg-white p-7 shadow-xl shadow-blue-100/55 transition hover:-translate-y-1 hover:shadow-2xl">
              <h3 className="text-2xl font-black text-slate-950">Business impact</h3>
              <p className="mt-4 leading-8 text-slate-600">We build things that help real businesses grow.</p>
            </article>
          </div>
