    ...
    <section id="products" className="relative overflow-hidden px-6 py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative overflow-hidden py-4">
          <div className="pointer-events-none absolute left-0 top-0 z-20 h-full w-32 bg-gradient-to-r from-[#fbfdff] via-[#fbfdff]/85 to-transparent" />
          <div className="pointer-events-none absolute right-0 top-0 z-20 h-full w-32 bg-gradient-to-l from-[#fbfdff] via-[#fbfdff]/85 to-transparent" />

          <div className="auto-apps-marquee">
            <div className="auto-apps-track">
              {appsLoop.map((app, index) => (
                <Link
                  href={`/apps/${app.slug}`}
                  key={`${app.slug}-${index}`}
                  className="auto-app-card group"
                >
                  <div className="relative flex h-full flex-col overflow-hidden rounded-[2.4rem] border border-blue-100/80 bg-white/90 p-7 shadow-xl shadow-blue-100/45 backdrop-blur-xl transition-all duration-500 ease-out hover:-translate-y-3 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-200/60">
                    ...
                    <div className="relative mt-8">
                      ...
                      <h3 className="mt-6 text-3xl font-black leading-tight tracking-tight text-slate-950">
                        {app.name}
                      </h3>
